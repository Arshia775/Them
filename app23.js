 ...
 * - /gh/Arshia775/Them@master/app.js
 *
...
<div class="mdui-textfield">
	...
	<input id="mdui-textfield-input23" class="mdui-textfield-input" style="width: 80%;" type="text" value="${href}"/>
	<div class="tooltip">
<button class="btn-cpy" onclick="myFunction()" onmouseout="outFunc()">
...
<div class="mdui-container-fluid">
	...
	<div class="mdui-textfield">
	  ...
	  <input id="mdui-textfield-input23" class="mdui-textfield-input" style="width: 80%;" type="text" value="${url}"/>
	  <div class="tooltip">
<button class="btn-cpy" onclick="myFunction()" onmouseout="outFunc()">
  <span class="tooltiptext" id="myTooltip">Copy to clipboard</span>
  Copy text
	...
	<div class="mdui-textfield">
	  ...
	  <textarea class="mdui-textfield-input" style="width: 80%;"><video><source src="${url}" type="video/mp4"></video></textarea>
	</div>
</div>
...
<button class="btn-cpy" onclick="myFunction()" onmouseout="outFunc()">
  ...
  Copy text
	...
	<div class="mdui-textfield">
	  <label class="mdui-textfield-label">HTML reference address</label>
	  <textarea class="mdui-textfield-input" style="width: 80%;"><audio><source src="${url}"></audio></textarea>
	</div>
</div>
<a href="${url}" class="mdui-fab mdui-fab-fixed mdui-ripple mdui-color-theme-accent"><i class="mdui-icon material-icons">file_download</i></a>
	`;
...
<button class="btn-cpy" onclick="myFunction()" onmouseout="outFunc()">
  ...
  Copy text
	...
	<div class="mdui-textfield">
	  ...
	  <input class="mdui-textfield-input" style="width: 80%;" type="text" value="<img src='${url}' />"/>
	</div>
        <div class="mdui-textfield">
	  <label class="mdui-textfield-label">Markdown reference address</label>
	  <input class="mdui-textfield-input" style="width: 80%;" type="text" value="![](${url})"/>
	</div>
        <br>
</div>
<a href="${url}" class="mdui-fab mdui-fab-fixed mdui-ripple mdui-color-theme-accent"><i class="mdui-icon material-icons">file_download</i></a>
...
//# sourceMappingURL=/sm/0d55965ec9b13f2a8acc81062b9720768299c031832c31296cc2d04ffe21484c.map
